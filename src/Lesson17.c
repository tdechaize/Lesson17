...
*
* \brief      Fonction NeHeLoadBitmap2 : charge deux fichiers BMP en mémoire pour générer un tableau de deux textures
* \details    En entrée les deux noms des fichiers Bitmap et en sortie le tableau des deux textures utilisables avec OpenGL
* \param	  szFileName			nom du premier fichier BMP			                *
* \param	  szFileName1			nom du deuxième fichier BMP			                *
* \param	  *texid			    un pointeur sur le tableau des deux textures générées			    *
* \return     bool                  un booleen, le tableau des deux textures créées ou non.
*
*/
...
* \param      string        la chaîne de caractère à imprimer
* \param      set           un entier
* \return     GLvoid        un void OpenGL.
*
*/
