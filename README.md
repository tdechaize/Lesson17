# Lesson17
Lesson17 Open (from NeHe)

Vous trouverez dans le sommaire ci-dessous les explications permetannt la regénération de cette application illustrant OpenGL : une fonction d'affichage 
de fontes en mode 2D (issu du site NeHe). 
...
En voici un succinct résumé :

## OpenGL Tutorial #17.

Project Name: Jeff Molofee's OpenGL Tutorial

Project Description : 2D Font Tutorial

Authors Name: Jeff Molofee (aka NeHe) and Guiseppe d'Agata 
